...
(1, 'Dr. Bariza Sabhrina', 'Dokter Umum'),
(2, 'Harena Iqlima', 'Kebidanan'),
(3, 'Drg. Sri Eka', 'Dokter Gigi');
...
(4, 'admin', '123', 'Administrator', 'A001', 'A'),
(5, 'bunga', '123', 'Bunga Rizka Fadillah', 'A002', 'A');
